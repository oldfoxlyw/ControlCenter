			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                    <div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
      				<form id="myForm" name="myForm" method="post" action="uninstalls">
                    ...
                    <div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
                    	<table id="report_graph" class="report_list">
                   		<?php if($report_type=='1'): ?>
                        	<caption><?php echo $year1; ?>年<?php echo $month1; ?>月<?php echo $date1; ?>日前一周卸载次数统计</caption>
                   		<?php elseif($report_type=='2'): ?>
                        	<caption><?php echo $year1; ?>年<?php echo $month1; ?>月<?php echo $date1; ?>日卸载次数统计</caption>
                   		<?php elseif($report_type=='3'): ?>
                        	<caption><?php echo $year1; ?>年<?php echo $month1; ?>月卸载次数统计</caption>
                   		<?php elseif($report_type=='4'): ?>
                        	<caption><?php echo $year1; ?>年卸载次数统计</caption>
                   		<?php elseif($report_type=='5'): ?>
                        	<caption><?php echo $year3; ?>年<?php echo $month3; ?>月<?php echo $date3; ?>日-<?php echo $year4; ?>年<?php echo $month4; ?>月<?php echo $date4; ?>日卸载次数统计</caption>
                        <?php endif; ?>
                        	<thead>
							<?php if($report_type=='1'): ?>
                            	<tr>
							...
							<?php if($report_type=='1'): ?>
                            	<tr>
                                	<th scope="row"><?php echo $year1; ?>年<?php echo $month1; ?>月<?php echo $date1; ?>日前一周卸载次数(次)</th>
                                	<?php foreach($result as $row): ?>
                                ...
                                <tr>
                                	<th scope="row"><?php echo $year2; ?>年<?php echo $month2; ?>月<?php echo $date2; ?>日前一周卸载次数(次)</th>
                            ...
                            <?php elseif($report_type=='2'): ?>
                            	<tr>
                                	<th scope="row"><?php echo $year1; ?>年<?php echo $month1; ?>月<?php echo $date1; ?>日各时段卸载次数(次)</th>
                                	<?php foreach($result as $row): ?>
                                	<td><?php echo $row['count']; ?></td>
                                	<?php endforeach; ?>
                                </tr>
                                <?php if(!empty($multi_result)): ?>
                                <tr>
                                	<th scope="row"><?php echo $year2; ?>年<?php echo $month2; ?>月<?php echo $date2; ?>日各时段卸载次数(次)</th>
                                	<?php foreach($multi_result as $row): ?>
                                	<td><?php echo $row['count']; ?></td>
                                	<?php endforeach; ?>
                                </tr>
                            ...
                            <?php elseif($report_type=='3'): ?>
                            	<tr>
                                	<th scope="row"><?php echo $year1; ?>年<?php echo $month1; ?>月卸载次数(次)</th>
                                	<?php foreach($result as $row): ?>
                                	<td><?php echo $row->count; ?></td>
                                	<?php endforeach; ?>
                                </tr>
                                <?php if(!empty($multi_result)): ?>
                                <tr>
                                	<th scope="row"><?php echo $year2; ?>年<?php echo $month2; ?>月卸载次数(次)</th>
                                	<?php foreach($multi_result as $row): ?>
                                	<td><?php echo $row->count; ?></td>
                                	<?php endforeach; ?>
                                </tr>
                            ...
                            <?php elseif($report_type=='4'): ?>
                            	<tr>
                                	<th scope="row"><?php echo $year1; ?>年卸载次数(次)</th>
                                	<?php foreach($result as $row): ?>
                                	<td><?php echo $row->count; ?></td>
                                	<?php endforeach; ?>
                                </tr>
                                <?php if(!empty($multi_result)): ?>
                                <tr>
                                	<th scope="row"><?php echo $year2; ?>年卸载次数(次)</th>
                                	<?php foreach($multi_result as $row): ?>
                                	<td><?php echo $row->count; ?></td>
                                	<?php endforeach; ?>
                                </tr>
                            ...
                            <?php elseif($report_type=='5'): ?>
                            	<tr>
                                	<th scope="row"><?php echo $year3; ?>年<?php echo $month3; ?>月<?php echo $date3; ?>日-<?php echo $year4; ?>年<?php echo $month4; ?>月<?php echo $date4; ?>日卸载次数(次)</th>
                                	<?php foreach($result as $row): ?>
                                	<td><?php echo $row['count']; ?></td>
                                	<?php endforeach; ?>
                                </tr>
