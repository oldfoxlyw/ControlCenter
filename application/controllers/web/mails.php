...
class Mails extends CI_Controller {
	...
	private $permissionName = 'web_mail';
	...
	public function index() {
		...
		$result = $this->mail->getAllResult(null, $itemPerPage, $offset);
