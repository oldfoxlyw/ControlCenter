...
$db['webdb']['username'] = 'tdatctsc';
$db['webdb']['password'] = 'Huir763lsiurelsfue';
$db['webdb']['database'] = 'tdatctsc_scc_webdb';
...
$db['accountdb']['username'] = 'tdatctsc';
$db['accountdb']['password'] = 'Huir763lsiurelsfue';
$db['accountdb']['database'] = 'tdatctsc_scc_accountdb';
...
$db['logdb']['username'] = 'tdatctsc';
$db['logdb']['password'] = 'Huir763lsiurelsfue';
$db['logdb']['database'] = "tdatctsc_scc_logdb_20133";
...
$db['weblogdb']['username'] = 'tdatctsc';
$db['weblogdb']['password'] = 'Huir763lsiurelsfue';
$db['weblogdb']['database'] = "tdatctsc_scc_weblogdb_20113";
...
$db['productdb']['username'] = 'tdatctsc';
$db['productdb']['password'] = 'Huir763lsiurelsfue';
$db['productdb']['database'] = 'tdatctsc_scc_productdb';
...
$db['authdb']['username'] = 'tdatctsc';
$db['authdb']['password'] = 'Huir763lsiurelsfue';
$db['authdb']['database'] = 'tdatctsc_scc_authorization';
...
$db['comdb']['username'] = 'tdatctsc';
$db['comdb']['password'] = 'Huir763lsiurelsfue';
$db['comdb']['database'] = 'tdatctsc_scc_commercial';
...
$db['promotiondb']['username'] = 'tdatctsc';
$db['promotiondb']['password'] = 'Huir763lsiurelsfue';
$db['promotiondb']['database'] = 'tdatctsc_scc_promotion';
